import { Configuration, EndpointHeadersIn, EndpointHeadersOut, EndpointHeadersPatchIn, EndpointIn, EndpointOauthConfigIn, EndpointOut, EndpointPatch, EndpointSecretOut, EndpointSecretRotateIn, EndpointStats, EndpointTransformationIn, EndpointTransformationOut, EndpointUpdate, EventExampleIn, ListResponseEndpointOut, MessageOut, Ordering, RecoverIn, RecoverOut, ReplayIn, ReplayOut } from "../openapi";
...
export declare class Endpoint {
    ...
    recover(appId: string, endpointId: string, recoverIn: RecoverIn, options?: PostOptions): Promise<RecoverOut>;
    replayMissing(appId: string, endpointId: string, replayIn: ReplayIn, options?: PostOptions): Promise<ReplayOut>;
