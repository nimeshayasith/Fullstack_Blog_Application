import { Configuration, ListResponseEndpointMessageOut, ListResponseMessageAttemptOut, ListResponseMessageEndpointOut, MessageAttemptOut, MessageStatus, StatusCodeClass } from "../openapi";
...
export declare class MessageAttempt {
    ...
    list(appId: string, msgId: string, options?: MessageAttemptListByMsgOptions): Promise<ListResponseMessageAttemptOut>;
