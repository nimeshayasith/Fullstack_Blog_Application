...
export declare class MessageAttemptApiRequestFactory extends BaseAPIRequestFactory {
    v1MessageAttemptCountByEndpoint(appId: string, endpointId: string, status?: MessageStatus, statusCodeClass?: StatusCodeClass, channel?: string, tag?: string, before?: Date, after?: Date, eventTypes?: Array<string>, _options?: Configuration): Promise<RequestContext>;
...
export declare class MessageAttemptApiResponseProcessor {
    v1MessageAttemptCountByEndpointWithHttpInfo(response: ResponseContext): Promise<HttpInfo<CountOut>>;
