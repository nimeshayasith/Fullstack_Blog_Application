...
export declare class AuthenticationApiRequestFactory extends BaseAPIRequestFactory {
    ...
    v1AuthenticationCreateMessageToken(appId: string, createTokenIn: CreateTokenIn, idempotencyKey?: string, _options?: Configuration): Promise<RequestContext>;
    ...
    v1AuthenticationGetPollerToken(appId: string, endpointId: string, _options?: Configuration): Promise<RequestContext>;
    v1AuthenticationLogout(idempotencyKey?: string, _options?: Configuration): Promise<RequestContext>;
    v1AuthenticationRotatePollerToken(appId: string, endpointId: string, rotatePollerTokenIn: RotatePollerTokenIn, idempotencyKey?: string, _options?: Configuration): Promise<RequestContext>;
}
export declare class AuthenticationApiResponseProcessor {
    ...
    v1AuthenticationGetPollerTokenWithHttpInfo(response: ResponseContext): Promise<HttpInfo<AuthTokenOut>>;
    v1AuthenticationLogoutWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void>>;
    v1AuthenticationRotatePollerTokenWithHttpInfo(response: ResponseContext): Promise<HttpInfo<AuthTokenOut>>;
}
