...
export declare class MessageApiRequestFactory extends BaseAPIRequestFactory {
    ...
    v1EventsPublic(appId: string, sinkId: string, limit?: number, iterator?: string, eventType?: string, channel?: string, after?: Date, _options?: Configuration): Promise<RequestContext>;
...
export declare class MessageApiResponseProcessor {
    ...
    v1EventsPublicWithHttpInfo(response: ResponseContext): Promise<HttpInfo<MessageEventsOut>>;
