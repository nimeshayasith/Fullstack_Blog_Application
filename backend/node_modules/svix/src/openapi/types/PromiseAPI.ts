...
export class PromiseAuthenticationApi {
     ...
     * @param [idempotencyKey] The request\&#39;s idempotency key
     */
    public v1AuthenticationCreateMessageTokenWithHttpInfo(appId: string, createTokenIn: CreateTokenIn, idempotencyKey?: string, _options?: Configuration): Promise<HttpInfo<AuthTokenOut>> {
        const result = this.api.v1AuthenticationCreateMessageTokenWithHttpInfo(appId, createTokenIn, idempotencyKey, _options);
        return result.toPromise();
    }
     ...
     * @param [idempotencyKey] The request\&#39;s idempotency key
     */
    public v1AuthenticationCreateMessageToken(appId: string, createTokenIn: CreateTokenIn, idempotencyKey?: string, _options?: Configuration): Promise<AuthTokenOut> {
        const result = this.api.v1AuthenticationCreateMessageToken(appId, createTokenIn, idempotencyKey, _options);
        return result.toPromise();
    }
     ...
     */
    public v1AuthenticationGetPollerTokenWithHttpInfo(appId: string, endpointId: string, _options?: Configuration): Promise<HttpInfo<AuthTokenOut>> {
        const result = this.api.v1AuthenticationGetPollerTokenWithHttpInfo(appId, endpointId, _options);
        return result.toPromise();
    }
     ...
     * @param endpointId The ep\&#39;s ID or UID
     */
    public v1AuthenticationGetPollerToken(appId: string, endpointId: string, _options?: Configuration): Promise<AuthTokenOut> {
        const result = this.api.v1AuthenticationGetPollerToken(appId, endpointId, _options);
        return result.toPromise();
    }
     ...
     * @param [idempotencyKey] The request\&#39;s idempotency key
     */
    public v1AuthenticationRotatePollerTokenWithHttpInfo(appId: string, endpointId: string, rotatePollerTokenIn: RotatePollerTokenIn, idempotencyKey?: string, _options?: Configuration): Promise<HttpInfo<AuthTokenOut>> {
        const result = this.api.v1AuthenticationRotatePollerTokenWithHttpInfo(appId, endpointId, rotatePollerTokenIn, idempotencyKey, _options);
        return result.toPromise();
    }
     ...
     * @param [idempotencyKey] The request\&#39;s idempotency key
     */
    public v1AuthenticationRotatePollerToken(appId: string, endpointId: string, rotatePollerTokenIn: RotatePollerTokenIn, idempotencyKey?: string, _options?: Configuration): Promise<AuthTokenOut> {
        const result = this.api.v1AuthenticationRotatePollerToken(appId, endpointId, rotatePollerTokenIn, idempotencyKey, _options);
        return result.toPromise();
    }
...
export class PromiseEndpointApi {
     ...
     * @param [idempotencyKey] The request\&#39;s idempotency key
     */
    public v1EndpointReplayMissingWithHttpInfo(appId: string, endpointId: string, replayIn: ReplayIn, idempotencyKey?: string, _options?: Configuration): Promise<HttpInfo<ReplayOut>> {
        const result = this.api.v1EndpointReplayMissingWithHttpInfo(appId, endpointId, replayIn, idempotencyKey, _options);
        return result.toPromise();
    }
     ...
     * @param [idempotencyKey] The request\&#39;s idempotency key
     */
    public v1EndpointReplayMissing(appId: string, endpointId: string, replayIn: ReplayIn, idempotencyKey?: string, _options?: Configuration): Promise<ReplayOut> {
        const result = this.api.v1EndpointReplayMissing(appId, endpointId, replayIn, idempotencyKey, _options);
        return result.toPromise();
    }
...
export class PromiseMessageApi {
     ...
     * @param [after]
     */
    public v1EventsPublicWithHttpInfo(appId: string, sinkId: string, limit?: number, iterator?: string, eventType?: string, channel?: string, after?: Date, _options?: Configuration): Promise<HttpInfo<MessageEventsOut>> {
        const result = this.api.v1EventsPublicWithHttpInfo(appId, sinkId, limit, iterator, eventType, channel, after, _options);
        return result.toPromise();
    }
     ...
     * @param [after]
     */
    public v1EventsPublic(appId: string, sinkId: string, limit?: number, iterator?: string, eventType?: string, channel?: string, after?: Date, _options?: Configuration): Promise<MessageEventsOut> {
        const result = this.api.v1EventsPublic(appId, sinkId, limit, iterator, eventType, channel, after, _options);
        return result.toPromise();
    }
...
export class PromiseMessageAttemptApi {
     ...
     * @param [eventTypes] Filter response based on the event type
     */
    public v1MessageAttemptCountByEndpointWithHttpInfo(appId: string, endpointId: string, status?: MessageStatus, statusCodeClass?: StatusCodeClass, channel?: string, tag?: string, before?: Date, after?: Date, eventTypes?: Array<string>, _options?: Configuration): Promise<HttpInfo<CountOut>> {
        const result = this.api.v1MessageAttemptCountByEndpointWithHttpInfo(appId, endpointId, status, statusCodeClass, channel, tag, before, after, eventTypes, _options);
        return result.toPromise();
    }
     ...
     * @param [eventTypes] Filter response based on the event type
     */
    public v1MessageAttemptCountByEndpoint(appId: string, endpointId: string, status?: MessageStatus, statusCodeClass?: StatusCodeClass, channel?: string, tag?: string, before?: Date, after?: Date, eventTypes?: Array<string>, _options?: Configuration): Promise<CountOut> {
        const result = this.api.v1MessageAttemptCountByEndpoint(appId, endpointId, status, statusCodeClass, channel, tag, before, after, eventTypes, _options);
        return result.toPromise();
    }
